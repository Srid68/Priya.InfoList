...
function refreshSubscriberList(pageNo, itemsPerPage, dataIndex, templateSuffix) {
    ...
    var postMethod = "GetSubscriberListView";
        ...
        success: function (returnObj) {
            ...
            if (returnObj.hasOwnProperty('error') == false) {
                ...
                if (retData.hasOwnProperty('html')) {
                    $('#subscriberList').html(retData.html);
                    $('#subscriberList').listview('refresh');
                    $('#subscriberList').trigger('create');
                }
            } else {
