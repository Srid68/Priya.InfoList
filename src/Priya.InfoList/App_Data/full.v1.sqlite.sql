...
CREATE TABLE [LTD_InfoDetail] (
	...
	"HideDetailName"		bit NOT NULL DEFAULT 0,
...
CREATE TABLE [LTD_InfoPage] (
	...
	"CommentorGroupList"		varchar(150) COLLATE NOCASE,
	"CommentorHideRoleList"		varchar(150) COLLATE NOCASE,
	"CommentorHideGroupList"		varchar(150) COLLATE NOCASE,
	"IsActive"		bit NOT NULL,
...
CREATE TABLE [LTD_InfoSection] (
	...
	"HideSectionName"		bit NOT NULL DEFAULT 0,
	"IsDeleted"		bit NOT NULL
,
    FOREIGN KEY ([InfoPageID] , [InfoPageGUID])
        REFERENCES [LTD_InfoPage]([InfoPageID] , [InfoPageGUID])
...
CREATE TABLE [SCD_Invite] (
	...
	"InviteDefaultRole"		varchar(50) NOT NULL COLLATE NOCASE DEFAULT 'GuestRole',
...
CREATE TABLE [SYS_ActionRole] (
	...
	"ActionErrorMessage"		varchar(250) NOT NULL COLLATE NOCASE DEFAULT 'Your Assigned Role cannot do this action',
...
CREATE TABLE [SYC_UserProfile] (
	...
	"MobileTheme"		varchar(50) NOT NULL COLLATE NOCASE,
...
INSERT INTO SYC_Config (ConfigID, ConfigGUID, RevisionNo, UserID, UserGUID, CreatedDate, LastUpdateDate, ConfigName, ConfigDescription, ConfigValue, ConfigAcceptValue, DataMaxLength, DataMinLength, IsUserConfig, IsActive) VALUES (1, '1e324b7d-4b8a-4b4e-9023-737f36f0fd22', 701, 10087, 'fda18837-ff81-4bb3-b331-d8b5977a003a', '2012-01-25 06:53:36', '2012-11-08 06:40:04', 'DefaultView', 'DefaultView', 'DOCUMENTVIEW', NULL, 250, 0, 0, 1);
INSERT INTO SYC_Config (ConfigID, ConfigGUID, RevisionNo, UserID, UserGUID, CreatedDate, LastUpdateDate, ConfigName, ConfigDescription, ConfigValue, ConfigAcceptValue, DataMaxLength, DataMinLength, IsUserConfig, IsActive) VALUES (2, '7716f974-88e2-4157-be14-a4163b3e7d55', 702, 10087, 'fda18837-ff81-4bb3-b331-d8b5977a003a', '2012-01-25 06:53:36', '2012-11-08 06:40:04', 'DefaultSiteName', 'DefaultSiteName', 'Arshu Consultancy', NULL, 250, 0, 0, 1);
INSERT INTO SYC_Config (ConfigID, ConfigGUID, RevisionNo, UserID, UserGUID, CreatedDate, LastUpdateDate, ConfigName, ConfigDescription, ConfigValue, ConfigAcceptValue, DataMaxLength, DataMinLength, IsUserConfig, IsActive) VALUES (3, 'bcc52c24-e537-4573-bfa8-a4a1b69a787e', 703, 10087, 'fda18837-ff81-4bb3-b331-d8b5977a003a', '2012-01-25 06:53:36', '2012-11-08 06:40:04', 'ForceLogin', 'Force the Login', 'True', NULL, 5, 4, 0, 1);
INSERT INTO SYC_Config (ConfigID, ConfigGUID, RevisionNo, UserID, UserGUID, CreatedDate, LastUpdateDate, ConfigName, ConfigDescription, ConfigValue, ConfigAcceptValue, DataMaxLength, DataMinLength, IsUserConfig, IsActive) VALUES (4, 'bd788965-137a-4465-9bd2-6fe3737930bf', 706, 10087, 'fda18837-ff81-4bb3-b331-d8b5977a003a', '2012-01-25 06:53:36', '2012-11-08 06:40:04', 'ShowAccountInfo', 'Show Account Info', 'False', NULL, 5, 4, 0, 1);
INSERT INTO SYC_Config (ConfigID, ConfigGUID, RevisionNo, UserID, UserGUID, CreatedDate, LastUpdateDate, ConfigName, ConfigDescription, ConfigValue, ConfigAcceptValue, DataMaxLength, DataMinLength, IsUserConfig, IsActive) VALUES (5, 'b6b83e0d-164a-423e-9f32-a3e7c13178b9', 710, 10087, 'fda18837-ff81-4bb3-b331-d8b5977a003a', '2012-01-25 06:53:36', '2012-11-08 06:40:04', 'ShowLogInfo', 'Show Log Info', 'True', NULL, 5, 4, 0, 1);
INSERT INTO SYC_Config (ConfigID, ConfigGUID, RevisionNo, UserID, UserGUID, CreatedDate, LastUpdateDate, ConfigName, ConfigDescription, ConfigValue, ConfigAcceptValue, DataMaxLength, DataMinLength, IsUserConfig, IsActive) VALUES (6, '2c2c36bc-f834-4251-8720-6918312759ac', 707, 10087, 'fda18837-ff81-4bb3-b331-d8b5977a003a', '2012-01-25 06:53:36', '2012-11-08 06:40:04', 'ShowAPILink', 'Show the API Link', 'True', NULL, 5, 4, 0, 1);
INSERT INTO SYC_Config (ConfigID, ConfigGUID, RevisionNo, UserID, UserGUID, CreatedDate, LastUpdateDate, ConfigName, ConfigDescription, ConfigValue, ConfigAcceptValue, DataMaxLength, DataMinLength, IsUserConfig, IsActive) VALUES (7, 'f5d8558a-3abb-465a-b4c7-dcb1a9bf0dcc', 708, 10087, 'fda18837-ff81-4bb3-b331-d8b5977a003a', '2012-01-25 06:53:36', '2012-11-08 06:40:04', 'ShowSettingLink', 'Show the Setting Link', 'True', NULL, 5, 4, 0, 1);
INSERT INTO SYC_Config (ConfigID, ConfigGUID, RevisionNo, UserID, UserGUID, CreatedDate, LastUpdateDate, ConfigName, ConfigDescription, ConfigValue, ConfigAcceptValue, DataMaxLength, DataMinLength, IsUserConfig, IsActive) VALUES (8, 'd95927da-13c5-46ba-953b-f4bdf34736fe', 704, 10087, 'fda18837-ff81-4bb3-b331-d8b5977a003a', '2012-01-25 06:53:36', '2012-11-08 06:40:04', 'ShowAutoRegisterLink', 'Show the Auto Register Link', 'True', NULL, 5, 4, 0, 1);
INSERT INTO SYC_Config (ConfigID, ConfigGUID, RevisionNo, UserID, UserGUID, CreatedDate, LastUpdateDate, ConfigName, ConfigDescription, ConfigValue, ConfigAcceptValue, DataMaxLength, DataMinLength, IsUserConfig, IsActive) VALUES (9, '2fb958dc-5a41-435b-99e0-5f4c6f999232', 705, 10087, 'fda18837-ff81-4bb3-b331-d8b5977a003a', '2012-01-25 06:53:36', '2012-11-08 06:40:04', 'ShowRegisterLink', 'Show the Register Link', 'False', NULL, 5, 4, 0, 1);
INSERT INTO SYC_Config (ConfigID, ConfigGUID, RevisionNo, UserID, UserGUID, CreatedDate, LastUpdateDate, ConfigName, ConfigDescription, ConfigValue, ConfigAcceptValue, DataMaxLength, DataMinLength, IsUserConfig, IsActive) VALUES (10, '04748118-feae-45b9-a4b6-029413a11174', 709, 10087, 'fda18837-ff81-4bb3-b331-d8b5977a003a', '2012-01-25 06:53:36', '2012-11-08 06:40:04', 'ShowTrackingLink', 'Show the Tracking Link', 'True', NULL, 5, 4, 0, 1);
INSERT INTO SYC_Config (ConfigID, ConfigGUID, RevisionNo, UserID, UserGUID, CreatedDate, LastUpdateDate, ConfigName, ConfigDescription, ConfigValue, ConfigAcceptValue, DataMaxLength, DataMinLength, IsUserConfig, IsActive) VALUES (20, 'b84ab6dd-0657-4467-b91d-e05f924ac2fb', 711, 10087, 'fda18837-ff81-4bb3-b331-d8b5977a003a', '2012-01-25 06:53:36', '2012-11-08 06:40:04', 'DateFormat', 'Date Format', 'dd/MMM/yyyy', NULL, 12, 1, 0, 1);
INSERT INTO SYC_Config (ConfigID, ConfigGUID, RevisionNo, UserID, UserGUID, CreatedDate, LastUpdateDate, ConfigName, ConfigDescription, ConfigValue, ConfigAcceptValue, DataMaxLength, DataMinLength, IsUserConfig, IsActive) VALUES (21, 'c2174cfc-00ad-4809-8b6c-732d5a4bda58', 712, 10087, 'fda18837-ff81-4bb3-b331-d8b5977a003a', '2012-01-25 06:53:36', '2012-11-08 06:40:04', 'DateFormatWithTime', 'Date Format With Time', 'dd/MMM/yyyy hh:mm:ss', NULL, 20, 1, 0, 1);
INSERT INTO SYC_Config (ConfigID, ConfigGUID, RevisionNo, UserID, UserGUID, CreatedDate, LastUpdateDate, ConfigName, ConfigDescription, ConfigValue, ConfigAcceptValue, DataMaxLength, DataMinLength, IsUserConfig, IsActive) VALUES (22, '8ffbf316-b07b-45db-933f-c0a409890839', 713, 10087, 'fda18837-ff81-4bb3-b331-d8b5977a003a', '2012-01-25 06:53:36', '2012-11-08 06:40:04', 'NumberFormat', 'Number Format', '{0:N3}', NULL, 6, 1, 0, 1);
INSERT INTO SYC_Config (ConfigID, ConfigGUID, RevisionNo, UserID, UserGUID, CreatedDate, LastUpdateDate, ConfigName, ConfigDescription, ConfigValue, ConfigAcceptValue, DataMaxLength, DataMinLength, IsUserConfig, IsActive) VALUES (23, '9014aabf-2f43-48d9-a998-e56ea4e261be', 714, 10087, 'fda18837-ff81-4bb3-b331-d8b5977a003a', '2012-01-25 06:53:36', '2012-11-08 06:40:04', 'CurrencyFormat', 'Currency Format', '{0:C3}', NULL, 6, 1, 0, 1);
INSERT INTO SYC_Config (ConfigID, ConfigGUID, RevisionNo, UserID, UserGUID, CreatedDate, LastUpdateDate, ConfigName, ConfigDescription, ConfigValue, ConfigAcceptValue, DataMaxLength, DataMinLength, IsUserConfig, IsActive) VALUES (50, '12af3a80-9d88-4d30-a438-a290de775f44', 636, 10087, 'fda18837-ff81-4bb3-b331-d8b5977a003a', '2012-01-25 06:53:36', '2012-11-08 01:45:45', 'ProductionTestMode', 'Production Test Mode', 'False', NULL, 5, 4, 0, 1);
INSERT INTO SYC_Config (ConfigID, ConfigGUID, RevisionNo, UserID, UserGUID, CreatedDate, LastUpdateDate, ConfigName, ConfigDescription, ConfigValue, ConfigAcceptValue, DataMaxLength, DataMinLength, IsUserConfig, IsActive) VALUES (51, 'edba3118-d712-44e2-a90b-0e092ce4da4e', 637, 10087, 'fda18837-ff81-4bb3-b331-d8b5977a003a', '2012-01-25 06:53:36', '2012-11-08 01:45:45', 'DevelopmentTestMode', 'Development Test Mode', 'True', NULL, 5, 4, 0, 1);
INSERT INTO SYC_Config (ConfigID, ConfigGUID, RevisionNo, UserID, UserGUID, CreatedDate, LastUpdateDate, ConfigName, ConfigDescription, ConfigValue, ConfigAcceptValue, DataMaxLength, DataMinLength, IsUserConfig, IsActive) VALUES (52, '70f7c08c-7dd9-4950-ad93-3f501b3609c8', 638, 10087, 'fda18837-ff81-4bb3-b331-d8b5977a003a', '2012-01-25 06:53:36', '2012-11-08 01:45:45', 'ResourceVersion', 'Resource Version', '1', NULL, 2, 1, 0, 1);
INSERT INTO SYC_Config (ConfigID, ConfigGUID, RevisionNo, UserID, UserGUID, CreatedDate, LastUpdateDate, ConfigName, ConfigDescription, ConfigValue, ConfigAcceptValue, DataMaxLength, DataMinLength, IsUserConfig, IsActive) VALUES (53, '7bc1f5c4-d70e-49f9-84fe-c9ca707b695a', 639, 10087, 'fda18837-ff81-4bb3-b331-d8b5977a003a', '2012-01-25 06:53:36', '2012-11-08 01:45:45', 'ResourceOptimize', 'Optimize Resources', 'True', NULL, 5, 4, 0, 1);
INSERT INTO SYC_Config (ConfigID, ConfigGUID, RevisionNo, UserID, UserGUID, CreatedDate, LastUpdateDate, ConfigName, ConfigDescription, ConfigValue, ConfigAcceptValue, DataMaxLength, DataMinLength, IsUserConfig, IsActive) VALUES (54, '11780585-cddf-4559-a0c7-41f900a84eee', 640, 10087, 'fda18837-ff81-4bb3-b331-d8b5977a003a', '2012-01-25 06:53:36', '2012-11-08 01:45:45', 'ResourceCompress', 'Compress Resources', 'True', NULL, 5, 4, 0, 1);
INSERT INTO SYC_Config (ConfigID, ConfigGUID, RevisionNo, UserID, UserGUID, CreatedDate, LastUpdateDate, ConfigName, ConfigDescription, ConfigValue, ConfigAcceptValue, DataMaxLength, DataMinLength, IsUserConfig, IsActive) VALUES (55, 'cbe5fa62-3649-4353-8fb1-2bf868b31e3e', 641, 10087, 'fda18837-ff81-4bb3-b331-d8b5977a003a', '2012-01-25 06:53:36', '2012-11-08 01:45:45', 'ResourceExpires', 'Expire Resources', 'True', NULL, 5, 4, 0, 1);
INSERT INTO SYC_Config (ConfigID, ConfigGUID, RevisionNo, UserID, UserGUID, CreatedDate, LastUpdateDate, ConfigName, ConfigDescription, ConfigValue, ConfigAcceptValue, DataMaxLength, DataMinLength, IsUserConfig, IsActive) VALUES (56, '19663127-9b9b-41e4-b709-8cef861a79c6', 642, 10087, 'fda18837-ff81-4bb3-b331-d8b5977a003a', '2012-01-25 06:53:36', '2012-11-08 01:45:45', 'ResourceCache', 'Cache Resources', 'False', NULL, 5, 4, 0, 1);
INSERT INTO SYC_Config (ConfigID, ConfigGUID, RevisionNo, UserID, UserGUID, CreatedDate, LastUpdateDate, ConfigName, ConfigDescription, ConfigValue, ConfigAcceptValue, DataMaxLength, DataMinLength, IsUserConfig, IsActive) VALUES (57, 'd507faf9-9bb8-4a22-aee8-a960f21997a5', 643, 10087, 'fda18837-ff81-4bb3-b331-d8b5977a003a', '2012-01-25 06:53:36', '2012-11-08 01:45:45', 'ResourceBase64', 'Base64 Image Resources', 'False', NULL, 5, 4, 0, 1);
INSERT INTO SYC_Config (ConfigID, ConfigGUID, RevisionNo, UserID, UserGUID, CreatedDate, LastUpdateDate, ConfigName, ConfigDescription, ConfigValue, ConfigAcceptValue, DataMaxLength, DataMinLength, IsUserConfig, IsActive) VALUES (58, '0636e0da-c444-43a4-a269-3bca2a0e2281', 644, 10087, 'fda18837-ff81-4bb3-b331-d8b5977a003a', '2012-01-25 06:53:36', '2012-11-08 01:45:45', 'ResourceSplit', 'Split Static Resources', 'False', NULL, 5, 4, 0, 1);
INSERT INTO SYC_Config (ConfigID, ConfigGUID, RevisionNo, UserID, UserGUID, CreatedDate, LastUpdateDate, ConfigName, ConfigDescription, ConfigValue, ConfigAcceptValue, DataMaxLength, DataMinLength, IsUserConfig, IsActive) VALUES (59, '5b282fc7-736f-4f4f-930f-413419ee8de4', 645, 10087, 'fda18837-ff81-4bb3-b331-d8b5977a003a', '2012-01-25 06:53:36', '2012-11-08 01:45:45', 'ResourceSplitMax', 'Max Split Static Resources', '3', NULL, 2, 1, 0, 1);
INSERT INTO SYC_Config (ConfigID, ConfigGUID, RevisionNo, UserID, UserGUID, CreatedDate, LastUpdateDate, ConfigName, ConfigDescription, ConfigValue, ConfigAcceptValue, DataMaxLength, DataMinLength, IsUserConfig, IsActive) VALUES (100, '806c78f9-cb9f-476a-8678-70688f2c7919', 612, 10087, 'fda18837-ff81-4bb3-b331-d8b5977a003a', '2012-01-25 06:53:36', '2012-11-04 06:55:19', 'StartPage', 'StartPage', 'INFOLIST', NULL, 250, 0, 1, 1);
INSERT INTO SYC_Config (ConfigID, ConfigGUID, RevisionNo, UserID, UserGUID, CreatedDate, LastUpdateDate, ConfigName, ConfigDescription, ConfigValue, ConfigAcceptValue, DataMaxLength, DataMinLength, IsUserConfig, IsActive) VALUES (101, '7e299edc-34f1-48dc-981a-a0df83b2f5e1', 615, 10087, 'fda18837-ff81-4bb3-b331-d8b5977a003a', '2012-01-25 06:53:36', '2012-11-04 06:55:19', 'ItemsPerPage', 'The Default Number of Items to Display in a Page', '2', NULL, 2, 1, 1, 1);
INSERT INTO SYC_Config (ConfigID, ConfigGUID, RevisionNo, UserID, UserGUID, CreatedDate, LastUpdateDate, ConfigName, ConfigDescription, ConfigValue, ConfigAcceptValue, DataMaxLength, DataMinLength, IsUserConfig, IsActive) VALUES (102, 'b0acd884-dca2-46c2-b665-7960fbd42c54', 619, 10087, 'fda18837-ff81-4bb3-b331-d8b5977a003a', '2012-01-25 06:53:36', '2012-11-04 06:55:19', 'InnerItemsPerPage', 'The Default Number of Items to Display Inside a Content', '4', NULL, 2, 1, 1, 1);
INSERT INTO SYC_Config (ConfigID, ConfigGUID, RevisionNo, UserID, UserGUID, CreatedDate, LastUpdateDate, ConfigName, ConfigDescription, ConfigValue, ConfigAcceptValue, DataMaxLength, DataMinLength, IsUserConfig, IsActive) VALUES (103, '24fb823a-d0b6-47ac-9079-0c07cb794188', 617, 10087, 'fda18837-ff81-4bb3-b331-d8b5977a003a', '2012-01-25 06:53:36', '2012-11-04 06:55:19', 'ItemsPerRow', 'The Default Number of Items to Display in a Row', '4', NULL, 2, 1, 1, 1);
INSERT INTO SYC_Config (ConfigID, ConfigGUID, RevisionNo, UserID, UserGUID, CreatedDate, LastUpdateDate, ConfigName, ConfigDescription, ConfigValue, ConfigAcceptValue, DataMaxLength, DataMinLength, IsUserConfig, IsActive) VALUES (104, 'aa0982cc-bda8-4f9f-9e5a-4308118805ca', 618, 10087, 'fda18837-ff81-4bb3-b331-d8b5977a003a', '2012-01-25 06:53:36', '2012-11-04 06:55:19', 'InfoItemsPerPage', 'The Default Number of Info Items to Display in a Page', '4', NULL, 2, 1, 1, 1);
...
INSERT INTO SYC_Config (ConfigID, ConfigGUID, RevisionNo, UserID, UserGUID, CreatedDate, LastUpdateDate, ConfigName, ConfigDescription, ConfigValue, ConfigAcceptValue, DataMaxLength, DataMinLength, IsUserConfig, IsActive) VALUES (106, 'f6f2c402-ecff-470c-b3e0-8a877eba4578', 613, 10087, 'fda18837-ff81-4bb3-b331-d8b5977a003a', '2012-01-25 06:53:36', '2012-11-04 06:55:19', 'MobileTheme', 'Mobile Theme ', 'Default', NULL, 30, 1, 1, 1);
INSERT INTO SYC_Config (ConfigID, ConfigGUID, RevisionNo, UserID, UserGUID, CreatedDate, LastUpdateDate, ConfigName, ConfigDescription, ConfigValue, ConfigAcceptValue, DataMaxLength, DataMinLength, IsUserConfig, IsActive) VALUES (107, '18fe43ee-c4cf-4975-aa66-05656c5b5097', 614, 10087, 'fda18837-ff81-4bb3-b331-d8b5977a003a', '2012-01-25 06:53:36', '2012-11-04 06:55:19', 'DefaultViewMode', 'Default View Mode (List, Thumb)', '0', NULL, 1, 1, 1, 1);
INSERT INTO SYC_Config (ConfigID, ConfigGUID, RevisionNo, UserID, UserGUID, CreatedDate, LastUpdateDate, ConfigName, ConfigDescription, ConfigValue, ConfigAcceptValue, DataMaxLength, DataMinLength, IsUserConfig, IsActive) VALUES (108, '4855c7f5-0c7b-4ca3-a19d-6d2d664eb8a1', 620, 10087, 'fda18837-ff81-4bb3-b331-d8b5977a003a', '2012-01-25 06:53:36', '2012-11-04 06:55:19', 'DefaultIconWidth', 'Default Width of Icon', '70', NULL, 3, 1, 1, 1);
INSERT INTO SYC_Config (ConfigID, ConfigGUID, RevisionNo, UserID, UserGUID, CreatedDate, LastUpdateDate, ConfigName, ConfigDescription, ConfigValue, ConfigAcceptValue, DataMaxLength, DataMinLength, IsUserConfig, IsActive) VALUES (109, 'cdee4f64-748f-4ba3-9a14-8722c8d5a489', 621, 10087, 'fda18837-ff81-4bb3-b331-d8b5977a003a', '2012-01-25 06:53:36', '2012-11-04 06:55:19', 'DefaultIconHeight', 'Default Height of Icon', '70', NULL, 3, 1, 1, 1);
INSERT INTO SYC_Config (ConfigID, ConfigGUID, RevisionNo, UserID, UserGUID, CreatedDate, LastUpdateDate, ConfigName, ConfigDescription, ConfigValue, ConfigAcceptValue, DataMaxLength, DataMinLength, IsUserConfig, IsActive) VALUES (110, '9cfd625f-7df5-4ac5-aa77-cebcb0ffe737', 622, 10087, 'fda18837-ff81-4bb3-b331-d8b5977a003a', '2012-01-25 06:53:36', '2012-11-04 06:55:19', 'DefaultImageWidth', 'Default Width of Image', '150', NULL, 3, 1, 1, 1);
INSERT INTO SYC_Config (ConfigID, ConfigGUID, RevisionNo, UserID, UserGUID, CreatedDate, LastUpdateDate, ConfigName, ConfigDescription, ConfigValue, ConfigAcceptValue, DataMaxLength, DataMinLength, IsUserConfig, IsActive) VALUES (111, 'be51340c-9b35-45a6-ab58-f6ad99ebdd04', 623, 10087, 'fda18837-ff81-4bb3-b331-d8b5977a003a', '2012-01-25 06:53:36', '2012-11-04 06:55:19', 'DefaulImageHeight', 'Default Height of Image', '150', NULL, 3, 1, 1, 1);
INSERT INTO SYC_Config (ConfigID, ConfigGUID, RevisionNo, UserID, UserGUID, CreatedDate, LastUpdateDate, ConfigName, ConfigDescription, ConfigValue, ConfigAcceptValue, DataMaxLength, DataMinLength, IsUserConfig, IsActive) VALUES (112, 'e9bd06b1-b817-4b8f-9c36-41efb2d93a1d', 624, 10087, 'fda18837-ff81-4bb3-b331-d8b5977a003a', '2012-01-25 06:53:36', '2012-11-04 06:55:19', 'DefaulAvatarSize', 'Default Size of Square Image', '80', NULL, 3, 1, 1, 1);




INSERT INTO SYC_UserProfile (UserProfileID, UserProfileGUID, RevisionNo, UserID, UserGUID, CreatedDate, LastUpdateDate, UserProfileName, StartPage, MobileTheme, DefaultViewMode, ItemsPerPage, InnerItemsPerPage, ItemsPerRow, InfoItemsPerPage, DetailItemsPerPage, DefaultIconWidth, DefaultIconHeight, DefaultImageWidth, DefaultImageHeight, DefaultAvatarSize, IsDefault, IsActive, Sequence) VALUES (1, '1b67e8c9-703e-426b-89d1-9176c276f5f5', 0, 2, 'ff97cb77-77c8-4800-8f3d-3ca7713f78d0', '2012-08-29 19:34:15', '2012-08-29 19:34:15', 'Default', NULL, 'Default', 0, 2, 4, 4, 4, 4, 70, 70, 150, 150, 80, 0, 0, 1);
...
INSERT INTO SYC_UserProfile (UserProfileID, UserProfileGUID, RevisionNo, UserID, UserGUID, CreatedDate, LastUpdateDate, UserProfileName, StartPage, MobileTheme, DefaultViewMode, ItemsPerPage, InnerItemsPerPage, ItemsPerRow, InfoItemsPerPage, DetailItemsPerPage, DefaultIconWidth, DefaultIconHeight, DefaultImageWidth, DefaultImageHeight, DefaultAvatarSize, IsDefault, IsActive, Sequence) VALUES (4, '35e4d347-d90a-49b3-943c-e02b26a12106', 0, 10087, 'fda18837-ff81-4bb3-b331-d8b5977a003a', '2012-11-04 06:55:25', '2012-11-04 06:55:25', 'Default', 'INFOLIST', 'Default', 0, 2, 4, 4, 4, 4, 70, 70, 150, 150, 80, 0, 0, 1);
