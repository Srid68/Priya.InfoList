...
CREATE TABLE `LTD_InfoDetail` (
	...
	`HideDetailName`		TINYINT NOT NULL DEFAULT 0,
...
CREATE TABLE `LTD_InfoPage` (
	...
	`CommentorGroupList`		VARCHAR(150)  ,
	`CommentorHideRoleList`		VARCHAR(150)  ,
	`CommentorHideGroupList`		VARCHAR(150)  ,
	`IsActive`		TINYINT NOT NULL,
...
CREATE TABLE `LTD_InfoSection` (
	...
	`HideSectionName`		TINYINT NOT NULL DEFAULT 0,
	`IsDeleted`		TINYINT NOT NULL
,
...
CREATE TABLE `SCD_Invite` (
	...
	`InviteDefaultRole`		VARCHAR(50) NOT NULL   DEFAULT 'GuestRole',
...
CREATE TABLE `SYS_ActionRole` (
	...
	`ActionErrorMessage`		VARCHAR(250) NOT NULL   DEFAULT 'Your Assigned Role cannot do this action',
...
CREATE TABLE `SYC_UserProfile` (
	...
	`MobileTheme`		VARCHAR(50) NOT NULL  ,
